<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"E:\fadmin\public/../application/admin\view\general\filemanager\index.html";i:1552616654;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/assets/addons/filemanager/styles/reset.css" />
        <link rel="stylesheet" type="text/css" href="/assets/addons/filemanager/styles/filemanager.css" />
        <link rel="stylesheet" type="text/css" href="/assets/addons/filemanager/scripts/jquery.contextmenu/dist/jquery.contextMenu.min.css" />
        <link rel="stylesheet" type="text/css" href="/assets/addons/filemanager/scripts/custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css" />
        <link rel="stylesheet" type="text/css" href="/assets/addons/filemanager/scripts/alertify.js/dist/css/alertify.css">

        <!--[if IE 9]>
        <link rel="stylesheet" type="text/css" href="/assets/addons/filemanager/styles/ie9.css" />
        <![endif]-->
        ...
        <style type="text/css">
            .fm-container .fm-loading-wrap {
                ...
                left: 0;
                display: block;
                background: white url(/assets/addons/filemanager/images/spinner.gif) no-repeat center center;
                z-index: 999;
            }
        </style>
    </head>
        ...
        <div class="fm-container">
            ...
            <div class="fm-wrapper">
                ...
                <script type="text/html" id="renderer-template">
                    ...
                    <script type="text/javascript" src="/assets/addons/filemanager/scripts/jquery-1.11.3.min.js"></script>
                    <!-- drag&drop + selectable build (includes customizations for RichFilemanager) -->
                    <script type="text/javascript" src="/assets/addons/filemanager/scripts/jquery-ui/jquery-ui.min.js"></script>
                    <script type="text/javascript" src="/assets/addons/filemanager/scripts/jquery-browser.js"></script>
                    <script type="text/javascript" src="/assets/addons/filemanager/scripts/knockout-3.4.0.js"></script>
                    <script type="text/javascript" src="/assets/addons/filemanager/scripts/jquery-mousewheel/jquery.mousewheel.min.js"></script>
                    <script type="text/javascript" src="/assets/addons/filemanager/scripts/jquery.splitter/dist/jquery-splitter.js"></script>
                    <script type="text/javascript" src="/assets/addons/filemanager/scripts/jquery.contextmenu/dist/jquery.contextMenu.min.js"></script>
                    <script type="text/javascript" src="/assets/addons/filemanager/scripts/alertify.js/dist/js/alertify.js"></script>
                    <script type="text/javascript" src="/assets/addons/filemanager/scripts/clipboard.js/dist/clipboard.min.js"></script>
                    <script type="text/javascript" src="/assets/addons/filemanager/scripts/jquery.fileDownload/jquery.fileDownload.min.js"></script>
                    <script type="text/javascript" src="/assets/addons/filemanager/scripts/javascript-templates/js/tmpl.min.js"></script>
                    <script type="text/javascript" src="/assets/addons/filemanager/scripts/toast/lib/toast.min.js"></script>
                    <script type="text/javascript" src="/assets/addons/filemanager/scripts/purl/purl.min.js"></script>
                    ...
                    <script type="text/javascript" src="/assets/addons/filemanager/scripts/filemanager.js"></script>

                    <!-- Start RichFilemanager plugin -->
                    <script type="text/javascript">
                        $(function () {
                        $('.fm-container').richFilemanager({
                        baseUrl: "/assets/addons/filemanager"
                        });
                        });
                    </script>
                </body>
