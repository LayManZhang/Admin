...
class Tag Extends Model
{
    ...
    {
        return addon_url('ask/tag/show', [':id' => $data['id'], ':name' => $data['name']], true);
    }

    public function getFullurlAttr($value, $data)
    {
        return addon_url('ask/tag/show', [':id' => $data['id'], ':name' => $data['name']], true, true);
    }
    ...
    public static function refresh($tags, $type, $source_id)
    {
        ...
        //取出所有标签列表
        $tagsList = self::getTags($type, $source_id);
