...
class Article extends Base
{
    ...
    public function index()
    {
        ...
        $articleList = \addons\ask\model\Article::getIndexArticleList($type, $categoryId);
    ...
    public function show()
    {
        ...
        $relatedArticleList = \addons\ask\model\Question::where('id', 'in', function ($query) use ($tagIds) {
    ...
    public function paynow()
    {
        ...
        $title = '付费查看文章';
        try {
            \addons\ask\library\Order::submit('answer', $article->id, $article->price, 'balance', $title);
