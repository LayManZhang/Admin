...
class Sitemap extends Base
{
    ...
    {
        $questionList = \addons\ask\model\Question::where('status', 'normal')->cache(3600)->field('id,createtime')->paginate(500000);
        $list = [];
    ...
    {
        $articleList = \addons\ask\model\Article::where('status', 'normal')->cache(3600)->field('id,createtime')->paginate(500000);
        $list = [];
    ...
    {
        $tagList = \addons\ask\model\Tag::where('status', 'normal')->cache(3600)->field('id,name,createtime')->paginate(500000);
        $list = [];
