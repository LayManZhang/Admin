$(function () {
    ...
    $(document).on("click", ".btn-comment", function () {
        ...
        if (subcomments.hasClass("hidden")) {
            $.ajax({
            ...
            subcomments.removeClass("hidden");
        } else {
            subcomments.addClass("hidden");
        }
    });
    ...
    $(document).on("click", ".btn-reply", function () {
        var form = Config.controllername === 'article' ? $(this).closest(".comment-footer").find(".comment-post").find("form") : $(this).closest(".comment-list").next().find("form");
    ...
    $(document).on("click", ".btn-money", function () {
        ...
        $("input[name='money'],input[name='price']", form).val($(this).data("money"));
    ...
    $(document).on("click", ".btn-paynow", function () {
        var that = this;
        var data = {id: $(that).data("id"), type: $(that).data("type"), price: $(that).data("price")};
        layer.open({
            title: "立即支付",
            type: 1,
