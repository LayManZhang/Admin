...
CREATE TABLE IF NOT EXISTS `__PREFIX__ask_answer` (
  ...
  `price` decimal(10,2) unsigned DEFAULT '0.00' COMMENT '付费偷看金额',
...
CREATE TABLE IF NOT EXISTS `__PREFIX__ask_article` (
  ...
  `flag` set('index','hot','recommend') DEFAULT NULL COMMENT '标志',
...
CREATE TABLE IF NOT EXISTS `__PREFIX__ask_block` (
  ...
  `url` varchar(100) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '链接',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='问答区块表';
...
CREATE TABLE IF NOT EXISTS `__PREFIX__ask_category` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `pid` int(10) unsigned DEFAULT '0' COMMENT '父ID',
  `type` enum('question','article','tag') DEFAULT 'question' COMMENT '类型',
...
CREATE TABLE IF NOT EXISTS `__PREFIX__ask_feed` (
  `id` smallint(8) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) DEFAULT NULL COMMENT '会员ID',
  `action` varchar(50) CHARACTER SET utf8 DEFAULT NULL COMMENT '动作',
  `type` enum('question','article','answer','comment') CHARACTER SET utf8 NOT NULL DEFAULT 'question' COMMENT '类型',
  `source_id` varchar(50) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '来源ID',
  `title` varchar(100) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '标题',
  `content` mediumtext CHARACTER SET utf8 COMMENT '内容',
  `createtime` int(10) DEFAULT NULL COMMENT '添加时间',
  `status` enum('normal','hidden') CHARACTER SET utf8 NOT NULL DEFAULT 'normal' COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='问答动态表';
...
CREATE TABLE IF NOT EXISTS `__PREFIX__ask_notification` (
  ...
  `type` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '类型',
  `source_id` int(10) unsigned NOT NULL COMMENT '来源ID',
  `title` varchar(128) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '标题',
...
CREATE TABLE IF NOT EXISTS `__PREFIX__ask_tag` (
  ...
  `name` varchar(50) CHARACTER SET utf8 DEFAULT '' COMMENT '名称',
...
-- ----------------------------
BEGIN;
INSERT INTO `__PREFIX__ask_block` VALUES (1, 'other', 'sidebarad1', '边栏广告1', '/assets/addons/ask/img/sidebar/howto.png', 'http://www.fastadmin.net', '', 1553821881, 1553821881, 'normal');
INSERT INTO `__PREFIX__ask_block` VALUES (2, 'other', 'sidebarad2', '边栏广告2', '/assets/addons/ask/img/sidebar/aliyun.png', 'http://www.fastadmin.net', '', 1553821881, 1553821881, 'normal');
COMMIT;
